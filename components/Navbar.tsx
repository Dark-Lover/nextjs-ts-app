      ...
      <nav className="">
        <ul className="flex flex-col pt-20 pb-10 px-8 sm:flex-row sm:gap-2 sm:pt-0 sm:pb-0 ">
          {menuItems.map((item, i) => (
            <li
              key={i}
              className="relative  border-b-2 py-2 px-2 cursor-pointer sm:border-b-0 sm:text-center sm:before:left-0 sm:before:ease-in-out sm:before:transition-all sm:before:absolute sm:before:w-0 sm:before:h-0.5 sm:before:bg-text-light_pumpk sm:before:bottom-0 sm:hover:before:w-full"
            >
              {item}
            </li>
          ))}
